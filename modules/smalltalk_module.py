...
TOXIC = {"дурак", "тупой", "убью", "сдохни", "ты дурак", "пошел ты", "ты идиот", "бесишь тварь", "ты долбаный дятел", "мудак", "какой ты дебил", "иди в жопу", "отвали идиот", "долбоеб", "иди на хрен", "ты тупой"}
